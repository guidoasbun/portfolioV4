    ...
    >
      ...
      <div className="w-full max-w-[48rem] rounded-2xl border border-primary/20 bg-surface p-xl md:p-3xl text-center shadow-lg">
        ...
        <div className="flex flex-wrap items-center justify-center gap-md mb-xl">
          ...
          <Link
            href="/resume"
            className="inline-flex items-center justify-center gap-xs min-h-[44px] px-lg py-sm rounded-lg border border-primary text-primary font-medium hover:bg-primary hover:text-foreground-inverse transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
          >
